...
var_emp_a <- mean((alpha_results - mean(alpha_results))^2)
bias_emp_a <- mean((alpha_results - 2))

cat("Variance for alpha ",var_emp)
cat("\n")
cat("Bias for alpha ", bias_emp)
cat("\n")
...
var_emp <- mean((beta_results - mean(beta_results))^2)
bias_emp <- mean((beta_results - 2))
...
var_emp <- mean((norm_results - mean(norm_results))^2)
bias_emp <- mean((norm_results - 2))
